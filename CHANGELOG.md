...
Release sections are either curated by hand under *Unreleased* and published
with `make release ARGS=--no-changelog`, or generated by `make release` from
the commit subjects since the previous release.
